...
Public Class PDFViewer
  ...
  Private mPDFViewerWidth As Integer
    ...
    '================================================
    Public Property ContinousPages() As Boolean
        Get
    ...
    Private mShowBottomToolBar As Boolean = False
    Public Property ShowBottomToolBar() As Boolean
        Get
            Return mShowBottomToolBar
        End Get
        Set(ByVal value As Boolean)
            mShowBottomToolBar = value
            tsBottom.Visible = mShowBottomToolBar
        End Set
    End Property
